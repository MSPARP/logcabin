...
<section>
  ...
  <form action="${request.route_path("account.change_password")}" method="post" class="body_section">
...
<section>
  ...
  <form action="${request.route_path("account.change_email")}" method="post" class="body_section ajax_form">
    <p class="error"></p>
